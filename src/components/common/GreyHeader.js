...
import HomeScreenNavigator from '../../../config/HomeScreenNavigator';
...
class GreyHeader extends Component {
    ...
    render () {
        return (
            <View style={{flex:1 }}>
                <View style={{flex: 1,  height: 40, backgroundColor:'#4C4C4C', flexDirection:'row', justifyContent:'space-between', alignItems:'center' }}>
                <TouchableHighlight
                ...
                <View style={{flex: 1, height: 70}}>{this.props.children}</View>
            </View>
        )
    }
}
